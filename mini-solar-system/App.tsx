...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full bg-black">
      ...
      <div
        className={`absolute top-4 left-4 text-white pointer-events-none transition-opacity duration-300 ${
          selectedPlanet ? "opacity-0" : "opacity-70"
        }`}
      >
        <h1 className="text-2xl font-bold tracking-wider">MINI SOLAR SYSTEM</h1>
        <h1 className="text-2xl font-bold tracking-wider">迷你太阳系</h1>
